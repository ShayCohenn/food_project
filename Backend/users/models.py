...
class UserProperties(models.Model):
    ...
    phone_num = models.CharField(max_length=64, unique=True, null=True)
...
class UserVerification(models.Model):
    ...
    verification_code = models.CharField(max_length=7,unique=True,default=0)
    expiration_time = models.DateTimeField(null=True)

class ForgotPasswodVerify(models.Model):
    email = models.EmailField(unique=True)
    verification_code = models.CharField(max_length=7,unique=True,default=0)
    expiration_time = models.DateTimeField(null=True)
