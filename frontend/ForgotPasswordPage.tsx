...
import { deleteResetPasswordAsync, resetPasswordAsync, sendPasswordResetEmailAsync } from "redux/features/async_functions/userAsyncSlice";
                    ...
                    {step === 0 &&
                        <div>
                            ...
                            <button onClick={() => {
                                ...
                                setStep(1)
                            }} className="btn btn-primary w-full mt-1">Send Verification Code</button>
                        </div>}
                    {step === 1 &&
                        <div className="flex flex-col">
                            ...
                            <button
                                disabled={isLoading}
                                onClick={() => handleReset} className="btn btn-primary mt-1">{isLoading ? "Sending" : "Reset Password"}{isLoading && <span className="loading loading-dots loading-xs"></span>}</button>
                        </div>
                    }
                </div>
            </div>
